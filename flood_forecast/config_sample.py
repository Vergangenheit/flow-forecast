...
"""example of a config dictionary for EU wind dataset where I'm trying to forecast the wind energy for Austria using DecoderTransformer"""
...
def make_config_file(file_path: str, df_len: int) -> Dict:
    ...
    config_default = {
        ...
        "model_type": "PyTorch",
        "takes_target": False,
        # this param appears to mean that the model forward pass takes in the target (not suited for DecoderTransformer")
        "model_params": {
            "n_time_series": 30,
            "n_head": 8,
            "forecast_history": 90,
